import os
from tkinter import *  # __all__ 서브 모듈은 안 불려와짐
...
def add_file():
    files = filedialog.askopenfilenames(title="이미지 파일을 선택하세요", \
                                        ...
                                        initialdir=r"C:\Users\Sanguook\PycharmProjects\nado_coding\nado_coding\활용편 2강\gui_project")  # 최초 경로를 설정, r : \ 특수문자 무시
...
# 선택 삭제
def del_file():
    for index in reversed(list_file.curselection()):  # 앞에서 부터 제거시 뒤 인덱스에 영향을 받으므로 영향을 받지 않는 뒤에서 부터 삭제
...
txt_dest_path.pack(side="left", fill="x", expand=True, padx=5, pady=5, ipady=4)  # 높이번경
